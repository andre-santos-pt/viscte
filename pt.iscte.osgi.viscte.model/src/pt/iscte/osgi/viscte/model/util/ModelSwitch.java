...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.BUNDLE_GRAPH: {
				BundleGraph bundleGraph = (BundleGraph)theEObject;
				T result = caseBundleGraph(bundleGraph);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bundle Graph</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bundle Graph</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBundleGraph(BundleGraph object) {
		return null;
	}
