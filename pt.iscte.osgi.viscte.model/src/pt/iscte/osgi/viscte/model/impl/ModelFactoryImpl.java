...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ModelPackage.BUNDLE_GRAPH: return createBundleGraph();
			...
			case ModelPackage.LIFECYCLE: return createLifecycle();
			default:
	 ...
	 * @generated
	 */
	public BundleGraph createBundleGraph() {
		BundleGraphImpl bundleGraph = new BundleGraphImpl();
		return bundleGraph;
	}
