 ...
 * <ul>
 *   <li>{@link pt.iscte.osgi.viscte.model.impl.ServiceImpl#getId <em>Id</em>}</li>
 *   <li>{@link pt.iscte.osgi.viscte.model.impl.ServiceImpl#getLifecycles <em>Lifecycles</em>}</li>
 *   <li>{@link pt.iscte.osgi.viscte.model.impl.ServiceImpl#getComponent <em>Component</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceImpl extends MinimalEObjectImpl.Container implements Service {
	...
	public EList<Lifecycle> getLifecycles() {
		if (lifecycles == null) {
			lifecycles = new EObjectContainmentEList<Lifecycle>(Lifecycle.class, this, ModelPackage.SERVICE__LIFECYCLES);
		}
		return lifecycles;
	}
	...
	public Component getComponent() {
		if (component != null && component.eIsProxy()) {
			...
			if (component != oldComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.SERVICE__COMPONENT, oldComponent, component));
			}
		}
		return component;
	}
	...
	public void setComponent(Component newComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SERVICE__COMPONENT, oldComponent, component));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SERVICE__LIFECYCLES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.SERVICE__COMPONENT:
